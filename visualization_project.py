...
st.subheader("""In our Data, there are 4 Mental Health Disorders we will try to explore, each of them is on a scale of 1-10 and reflects one surveyee's rate of himself regarding that score, the scores are Anxiety, Depression, Insomnia and OCD.""")
st.markdown("---")  
